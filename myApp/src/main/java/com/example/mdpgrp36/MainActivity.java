...
import com.example.mdpgrp36.Adapter.SectionsPagerAdapter;
import com.example.mdpgrp36.Arena.ArenaMap;
import com.example.mdpgrp36.Bluetooth.BluetoothConnectionService;
import com.example.mdpgrp36.Communication.ChatFragment;
    ...
    BroadcastReceiver messageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (newMessage.equals("invalid")){
                ...
                String[] splitNewMessage = newMessage.split(" ");
                for(int i=0; i<splitNewMessage.length; i++) {
                    showLog("splitNewMessage Received: " + splitNewMessage[i]);
                    arenaMap.updateMap(splitNewMessage[i]);
